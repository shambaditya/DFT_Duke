...
// Filename       : patterns/gps_baseband_transition_serial.v
// Scan operation : SERIAL
// Idstamp        : 2024.4:26a7:00e4:4:8122
// Fault          : TRANSITION
// Coverage       : 93.57(TC) 93.28(FC)
// Date           : Wed Oct 29 16:53:23 2025
//
// Begin_Verify_Section 
//   format            = Verilog 
//   top_module_name   = gps_baseband_gps_baseband_transition_serial_v_ctl 
//   serial_flag       = ON 
...
`define SIM_INSTANCE_NAME gps_baseband_inst


`timescale 1ns / 100ps

module gps_baseband_gps_baseband_transition_serial_v_ctl;
...
`endif
`ifdef MGC_DISABLE_CLOCK_MONITOR_gps_baseband_transition_serial
  `undef TESSENT_ENABLE_CLOCK_MONITOR
`endif
...
`ifdef TESSENT_DISABLE_CLOCK_MONITOR
  `undef TESSENT_ENABLE_CLOCK_MONITOR
`endif
`ifdef TESSENT_DISABLE_CLOCK_MONITOR_gps_baseband_transition_serial
  `undef TESSENT_ENABLE_CLOCK_MONITOR
`endif

`ifdef MGC_CLOCK_MONITOR_CYCLES_gps_baseband_transition_serial
  `undef TESSENT_CLOCK_MONITOR_CYCLES
  `define TESSENT_CLOCK_MONITOR_CYCLES `MGC_CLOCK_MONITOR_CYCLES_gps_baseband_transition_serial
`else
...
`ifdef TESSENT_CLOCK_MONITOR_CYCLES_gps_baseband_transition_serial
  `undef TESSENT_CLOCK_MONITOR_CYCLES
  `define TESSENT_CLOCK_MONITOR_CYCLES `TESSENT_CLOCK_MONITOR_CYCLES_gps_baseband_transition_serial
`endif
...
`ifdef MGC_CLOCK_MONITOR_PERIOD_MARGIN_PERCENT_gps_baseband_transition_serial
  `undef TESSENT_CLOCK_MONITOR_PERIOD_MARGIN_PERCENT
  `define TESSENT_CLOCK_MONITOR_PERIOD_MARGIN_PERCENT `MGC_CLOCK_MONITOR_PERIOD_MARGIN_PERCENT_gps_baseband_transition_serial
`else
...
`ifdef TESSENT_CLOCK_MONITOR_PERIOD_MARGIN_PERCENT_gps_baseband_transition_serial
  `undef TESSENT_CLOCK_MONITOR_PERIOD_MARGIN_PERCENT
  `define TESSENT_CLOCK_MONITOR_PERIOD_MARGIN_PERCENT `TESSENT_CLOCK_MONITOR_PERIOD_MARGIN_PERCENT_gps_baseband_transition_serial
`endif
...
`ifdef MGC_CONTINUE_ON_CLOCK_ERROR_gps_baseband_transition_serial
...
`ifdef TESSENT_CONTINUE_ON_CLOCK_ERROR_gps_baseband_transition_serial
  `undef TESSENT_STOP_ON_CLOCK_ERROR
`else
...
assign    _clock_monitor_0_clkNet  = gps_baseband_inst.clk ;
assign    _clock_monitor_1_clkNet  = gps_baseband_inst.gps_baseband_rtl1_tessent_occ_clk_inst.tessent_persistent_cell_fast_clock_buf.y ;
initial begin
$timeformat(-9, 3, "ns", 1);
...
always @(_stop_occ_clock_monitor) begin
  if ((_occ_clock_monitor_stop == 0) && (_occ_clock_monitor_start == 1)) begin
    ...
    if (_clock_monitor_1_cycle_counter == 0 ) begin
      $display ("%t: OCC fast clock input monitoring failed: gps_baseband_rtl1_tessent_occ_clk_inst.tessent_persistent_cell_fast_clock_buf.y.  No transition detected", $realtime);
      _clock_monitor_1_fail = _clock_monitor_1_fail + 1;
    end else begin
      $display ("%t: OCC fast clock input monitoring passed: gps_baseband_rtl1_tessent_occ_clk_inst.tessent_persistent_cell_fast_clock_buf.y.  Measured period = %.6t. Number of cycles = %0d. ", $realtime, _clock_monitor_1_measured_period, _clock_monitor_1_cycle_counter);
    end
...
always @(_start_occ_clock_monitor) begin
    ...
    _clock_monitor_1_cycle_counter      = 0;
    $display ($realtime, "ns: Start OCC fast clock input monitoring on:  gps_baseband_rtl1_tessent_occ_clk_inst.tessent_persistent_cell_fast_clock_buf.y");
end
// [start] : gps_baseband_rtl1_tessent_occ_clk_inst.tessent_persistent_cell_fast_clock_buf.y {{{
...
wire hw_rstn, sign, mag, chip_select, write, read, \address[7] , \address[6] , 
     \address[5] , \address[4] , \address[3] , \address[2] , \address[1] , 
     \address[0] , \write_data[31] , \write_data[30] , \write_data[29] , 
     \write_data[28] , \write_data[27] , \write_data[26] , \write_data[25] , 
     \write_data[24] , \write_data[23] , \write_data[22] , \write_data[21] , 
     \write_data[20] , \write_data[19] , \write_data[18] , \write_data[17] , 
     \write_data[16] , \write_data[15] , \write_data[14] , \write_data[13] , 
     ...
     \write_data[0] , scan_en_w, edt_update, test_clock_w, test_mode, 
     fast_capture_mode, capture_cycle_width_1, capture_cycle_width_0, 
     edt_bypass, edt_configuration, edt_low_power_shift_en, \gps_baseband_rtl1_controller_c1_edt_channels_in[3] , 
     \gps_baseband_rtl1_controller_c1_edt_channels_in[2] , \gps_baseband_rtl1_controller_c1_edt_channels_in[1] , 
     \gps_baseband_rtl1_controller_c1_edt_channels_in[0] , scan_reset, 
     ltest_en, \gps_baseband_rtl1_controller_c1_edt_channels_out[3] , 
     \gps_baseband_rtl1_controller_c1_edt_channels_out[2] , \gps_baseband_rtl1_controller_c1_edt_channels_out[1] , 
     \gps_baseband_rtl1_controller_c1_edt_channels_out[0] ;

event       before_finish;
assign hw_rstn = _ibus[59];
assign sign = _ibus[58];
assign mag = _ibus[57];
assign chip_select = _ibus[56];
assign write = _ibus[55];
assign read = _ibus[54];
assign \address[7]  = _ibus[53];
assign \address[6]  = _ibus[52];
assign \address[5]  = _ibus[51];
assign \address[4]  = _ibus[50];
assign \address[3]  = _ibus[49];
assign \address[2]  = _ibus[48];
assign \address[1]  = _ibus[47];
assign \address[0]  = _ibus[46];
assign \write_data[31]  = _ibus[45];
assign \write_data[30]  = _ibus[44];
assign \write_data[29]  = _ibus[43];
assign \write_data[28]  = _ibus[42];
assign \write_data[27]  = _ibus[41];
assign \write_data[26]  = _ibus[40];
assign \write_data[25]  = _ibus[39];
assign \write_data[24]  = _ibus[38];
assign \write_data[23]  = _ibus[37];
assign \write_data[22]  = _ibus[36];
assign \write_data[21]  = _ibus[35];
assign \write_data[20]  = _ibus[34];
assign \write_data[19]  = _ibus[33];
assign \write_data[18]  = _ibus[32];
assign \write_data[17]  = _ibus[31];
assign \write_data[16]  = _ibus[30];
assign \write_data[15]  = _ibus[29];
assign \write_data[14]  = _ibus[28];
assign \write_data[13]  = _ibus[27];
assign \write_data[12]  = _ibus[26];
assign \write_data[11]  = _ibus[25];
assign \write_data[10]  = _ibus[24];
assign \write_data[9]  = _ibus[23];
assign \write_data[8]  = _ibus[22];
assign \write_data[7]  = _ibus[21];
assign \write_data[6]  = _ibus[20];
assign \write_data[5]  = _ibus[19];
assign \write_data[4]  = _ibus[18];
assign \write_data[3]  = _ibus[17];
assign \write_data[2]  = _ibus[16];
assign \write_data[1]  = _ibus[15];
assign \write_data[0]  = _ibus[14];
assign scan_en_w = _ibus[13];
assign edt_update = _ibus[12];
assign test_clock_w = _ibus[11];
assign test_mode = _ibus[10];
assign fast_capture_mode = _ibus[9];
assign capture_cycle_width_1 = 1'b0;
assign capture_cycle_width_0 = _ibus[8];
assign edt_bypass = _ibus[7];
assign edt_configuration = _ibus[6];
assign edt_low_power_shift_en = _ibus[5];
assign \gps_baseband_rtl1_controller_c1_edt_channels_in[3]  = _ibus[4];
assign \gps_baseband_rtl1_controller_c1_edt_channels_in[2]  = _ibus[3];
assign \gps_baseband_rtl1_controller_c1_edt_channels_in[1]  = _ibus[2];
assign \gps_baseband_rtl1_controller_c1_edt_channels_in[0]  = _ibus[1];
assign scan_reset = _ibus[0];
assign ltest_en = 1'b1;

assign _sim_obus[3] = \gps_baseband_rtl1_controller_c1_edt_channels_out[3] ;
assign _sim_obus[2] = \gps_baseband_rtl1_controller_c1_edt_channels_out[2] ;
assign _sim_obus[1] = \gps_baseband_rtl1_controller_c1_edt_channels_out[1] ;
assign _sim_obus[0] = \gps_baseband_rtl1_controller_c1_edt_channels_out[0] ;
...
`ifdef VCD
    $sformat(_vcd_dump_file_name, "patterns/gps_baseband_transition_serial.v.dump");
...
`ifdef UTVCD
    $sformat(_utvcd_dump_file_name, "patterns/gps_baseband_transition_serial.v.dump");
    if(_change_out_path) begin 
...
`ifdef debussy
    $sformat(_fsdb_dump_file_name, "patterns/gps_baseband_transition_serial.v.fsdb");
    if(_change_out_path) begin 
...
`ifdef QWAVE
    $sformat(_qwave_dump_file_name, "patterns/gps_baseband_transition_serial.v.qwave.db");
    if(_change_out_path) begin 
...
reg /* sparse */[407:0] _nam_obus[3:0];
initial begin 
   if(_change_path) begin 
     $sformat(_new_filename,"%0s/patterns/gps_baseband_transition_serial.v.po.name",_new_path); 
     $display("Loading %0s\n", _new_filename ); 
     $readmemh(_new_filename,_nam_obus,3,0); 
   end 
   else begin
     $display("Loading patterns/gps_baseband_transition_serial.v.po.name");
     $readmemh("patterns/gps_baseband_transition_serial.v.po.name",_nam_obus,3,0);
   end 
end 
 ...
 if (_do_compare) begin
  ...
  if (_found_fail == 1) begin
    ...
    $write($realtime, "ns: Expected  response %b pattern %d cycle %d\n",_exp_obus,_pattern_count,_cycle_count);
     for(_bit_count = 0;
         ((_bit_count < 4)&&((_miscompare_limit==0)||(_compare_fail<=_miscompare_limit)));
          _bit_count =_bit_count +1) begin
      if ((_msk_obus[_bit_count] === 1'b1) &&
          (_exp_obus[_bit_count] !== _sim_obus[_bit_count])) begin
        _found_fail_obus[_bit_count] = 1'b1;
        ...
        if (_write_MASK_file == 0) begin
         if (_scan_shift_count != 0) begin 
            case (_bit_count) // Scan Chain Failure 
              0: begin
                      $write($realtime, "ns: Mismatch on chain: edt_gps_baseband_rtl1_tessent_edt_c1_inst__edt_block_channel1 at shift cycle: %d\n", (_scan_shift_count-1));
               end
              1: begin
                      $write($realtime, "ns: Mismatch on chain: edt_gps_baseband_rtl1_tessent_edt_c1_inst__edt_block_channel2 at shift cycle: %d\n", (_scan_shift_count-1));
               end
              2: begin
                      $write($realtime, "ns: Mismatch on chain: edt_gps_baseband_rtl1_tessent_edt_c1_inst__edt_block_channel3 at shift cycle: %d\n", (_scan_shift_count-1));
               end
              3: begin
                      $write($realtime, "ns: Mismatch on chain: edt_gps_baseband_rtl1_tessent_edt_c1_inst__edt_block_channel4 at shift cycle: %d\n", (_scan_shift_count-1));
               end
            endcase
        ...
        if (_write_DIAG_file == 1) begin
          if (_DIAG_file_header == 0) begin
            if ((_start_pat > -1) && (_end_pat > -1)) begin
              $sformat(_tmp_filename, "patterns/gps_baseband_transition_serial.v_%0d_%0d.fail",
                       _start_pat, _end_pat);
            end
            else if (_start_pat > -1) begin
              $sformat(_tmp_filename, "patterns/gps_baseband_transition_serial.v_%0d.fail",
                       _start_pat);
            end
            else if (_end_pat > -1) begin
              $sformat(_tmp_filename, "patterns/gps_baseband_transition_serial.v__%0d.fail",
                       _end_pat);
            end
            else begin
              $sformat(_tmp_filename, "patterns/gps_baseband_transition_serial.v.fail");
            end
            if(_change_out_path) begin 
            ...
            if(_change_out_path) begin 
              $fwrite(_diag_file, "// This File is simulation generated (%0s/patterns/gps_baseband_transition_serial.v)\n", _new_out_path);
            end
            else begin
              $fwrite(_diag_file, "// This File is simulation generated (patterns/gps_baseband_transition_serial.v)\n");
            end
         ...
         if (_scan_shift_count != 0) begin
          case (_bit_count) // Scan Chain Failure
            0: begin
                 $fwrite(_diag_file, "chain: edt_gps_baseband_rtl1_tessent_edt_c1_inst__edt_block_channel1  cell: %d, simulation_time=%.0f\n", (_scan_shift_count-1), $realtime);
                end
            1: begin
                 $fwrite(_diag_file, "chain: edt_gps_baseband_rtl1_tessent_edt_c1_inst__edt_block_channel2  cell: %d, simulation_time=%.0f\n", (_scan_shift_count-1), $realtime);
                end
            2: begin
                 $fwrite(_diag_file, "chain: edt_gps_baseband_rtl1_tessent_edt_c1_inst__edt_block_channel3  cell: %d, simulation_time=%.0f\n", (_scan_shift_count-1), $realtime);
                end
            3: begin
                 $fwrite(_diag_file, "chain: edt_gps_baseband_rtl1_tessent_edt_c1_inst__edt_block_channel4  cell: %d, simulation_time=%.0f\n", (_scan_shift_count-1), $realtime);
                end
          endcase
         end // EndIf  _ScanShift_count
        ...
        if (_write_MASK_file == 1) begin
          if (_MASK_file_header == 0) begin
            if ((_start_pat > -1) && (_end_pat > -1)) begin
              $sformat(_tmp_filename, "patterns/gps_baseband_transition_serial.v_%0d_%0d.mask",
                       _start_pat, _end_pat);
            end
            else if (_start_pat > -1) begin
              $sformat(_tmp_filename, "patterns/gps_baseband_transition_serial.v_%0d.mask",
                       _start_pat);
            end
            else if (_end_pat > -1) begin
              $sformat(_tmp_filename, "patterns/gps_baseband_transition_serial.v__%0d.mask",
                       _end_pat);
            end
            else begin
              $sformat(_tmp_filename, "patterns/gps_baseband_transition_serial.v.mask");
            end
            if(_change_out_path) begin 
              $sformat(_tmp_filename, "%0s/%0s", _new_out_path, _tmp_filename);
            end
         ...
         if (_scan_shift_count != 0) begin 
          case (_bit_count) // Scan Chain Failure 
            0: begin
                 ...
                 if (_chain_test_ == 0) begin
                   $fwrite(_mask_file, "%d %s %d\n",
                             _pattern_count, "edt_gps_baseband_rtl1_tessent_edt_c1_inst__edt_block_channel1", (_scan_shift_count-1));
                   _wrote_fail = 1;
                 end
            ...
            1: begin
                 ...
                 if (_chain_test_ == 0) begin
                   $fwrite(_mask_file, "%d %s %d\n",
                             _pattern_count, "edt_gps_baseband_rtl1_tessent_edt_c1_inst__edt_block_channel2", (_scan_shift_count-1));
                   _wrote_fail = 1;
                 end
                 if (_chain_test_ == 1) begin
                   $fwrite(_mask_file, "// %d %s %d\n",
            ...
            2: begin
                 ...
                 if (_chain_test_ == 0) begin
                   $fwrite(_mask_file, "%d %s %d\n",
                             _pattern_count, "edt_gps_baseband_rtl1_tessent_edt_c1_inst__edt_block_channel3", (_scan_shift_count-1));
                   _wrote_fail = 1;
                 end
                 if (_chain_test_ == 1) begin
                   $fwrite(_mask_file, "// %d %s %d\n",
            ...
            3: begin
                 ...
                 if (_chain_test_ == 0) begin
                   $fwrite(_mask_file, "%d %s %d\n",
                             _pattern_count, "edt_gps_baseband_rtl1_tessent_edt_c1_inst__edt_block_channel4", (_scan_shift_count-1));
                   _wrote_fail = 1;
                 end
                 if (_chain_test_ == 1) begin
                   $fwrite(_mask_file, "// %d %s %d\n",
...
reg[76:0]     mem [0:3486173];
gps_baseband gps_baseband_inst (.hw_rstn(hw_rstn), .sign(sign), 
     .mag(mag), .chip_select(chip_select), .write(write), 
     .read(read), .address({\address[7] , \address[6] 
     , \address[5] , \address[4] , \address[3] , \address[2] 
     , \address[1] , \address[0] }), .write_data({\write_data[31] 
     , \write_data[30] , \write_data[29] , \write_data[28] 
     , \write_data[27] , \write_data[26] , \write_data[25] 
     , \write_data[24] , \write_data[23] , \write_data[22] 
     , \write_data[21] , \write_data[20] , \write_data[19] 
     , \write_data[18] , \write_data[17] , \write_data[16] 
     , \write_data[15] , \write_data[14] , \write_data[13] 
     , \write_data[12] , \write_data[11] , \write_data[10] 
     , \write_data[9] , \write_data[8] , \write_data[7] 
     , \write_data[6] , \write_data[5] , \write_data[4] 
     , \write_data[3] , \write_data[2] , \write_data[1] 
     , \write_data[0] }), .scan_en_w(scan_en_w), 
     ...
     .gps_baseband_rtl1_controller_c1_edt_channels_in({\gps_baseband_rtl1_controller_c1_edt_channels_in[3] 
     , \gps_baseband_rtl1_controller_c1_edt_channels_in[2] 
     , \gps_baseband_rtl1_controller_c1_edt_channels_in[1] 
     , \gps_baseband_rtl1_controller_c1_edt_channels_in[0] }), 
     .scan_reset(scan_reset), .ltest_en(ltest_en), 
     .gps_baseband_rtl1_controller_c1_edt_channels_out({\gps_baseband_rtl1_controller_c1_edt_channels_out[3] 
     , \gps_baseband_rtl1_controller_c1_edt_channels_out[2] 
...
//  $display("Reading checkpoint patterns/gps_baseband_transition_serial.v.dat");
//  $restart("patterns/gps_baseband_transition_serial.v.dat");
end
...
if ($value$plusargs("CONFIG=%0s", _cfg_file_name)) begin
  ...
  _cfg_file_name = "patterns/gps_baseband_transition_serial.v.cfg";
end
...
if(_change_path) begin 
  $sformat(_new_filename,"%0s/patterns/gps_baseband_transition_serial.v.cfg",_new_path); 
  _config_file = $fopen(_new_filename, "r");
end
else begin
  _config_file = $fopen("patterns/gps_baseband_transition_serial.v.cfg", "r");
end
         ...
         3'b010:  begin // broadside vector
            ...
            case (_tp_num)
               1'b1: begin // timeplate 1 - gen_tp1
                  _ibus[11] = 1'b0;
                  _ibus[59:12] = vect[76:29];
                  _ibus[10:0] = vect[27:17];

                  #10; // 10 ns
                  _exp_obus[3:0] = vect[16:13];
                  _msk_obus[3:0] = vect[12:9];
                  #0;
                  ...
                  if ((_miscompare_limit)&&(_compare_fail>=_miscompare_limit)) begin
                    ...
                    if (_DIAG_file_header == 1) begin
                       ...
                       $fwrite(_diag_file, "total_cycles 3480\n");
...
//  $display("Writing checkpoint patterns/gps_baseband_transition_serial.v.dat");
//  $save("patterns/gps_baseband_transition_serial.v.dat");

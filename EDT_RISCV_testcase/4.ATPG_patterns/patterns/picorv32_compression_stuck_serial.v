...
// Filename       : patterns/picorv32_compression_stuck_serial.v
// Scan operation : SERIAL
// Idstamp        : 2024.4:f61e:7579:2:d144
// Fault          : STUCK
// Coverage       : 93.54(TC) 86.59(FC)
// Date           : Thu Nov 20 22:33:13 2025
//
// Begin_Verify_Section 
//   format            = Verilog 
//   top_module_name   = picorv32_picorv32_compression_stuck_serial_v_ctl 
//   serial_flag       = ON 
...
module picorv32_picorv32_compression_stuck_serial_v_ctl;
...
event       before_finish;
assign clk = _ibus[111];
assign resetn = _ibus[110];
assign mem_ready = _ibus[109];
assign \mem_rdata[31]  = _ibus[108];
assign \mem_rdata[30]  = _ibus[107];
assign \mem_rdata[29]  = _ibus[106];
assign \mem_rdata[28]  = _ibus[105];
assign \mem_rdata[27]  = _ibus[104];
assign \mem_rdata[26]  = _ibus[103];
assign \mem_rdata[25]  = _ibus[102];
assign \mem_rdata[24]  = _ibus[101];
assign \mem_rdata[23]  = _ibus[100];
assign \mem_rdata[22]  = _ibus[99];
assign \mem_rdata[21]  = _ibus[98];
assign \mem_rdata[20]  = _ibus[97];
assign \mem_rdata[19]  = _ibus[96];
assign \mem_rdata[18]  = _ibus[95];
assign \mem_rdata[17]  = _ibus[94];
assign \mem_rdata[16]  = _ibus[93];
assign \mem_rdata[15]  = _ibus[92];
assign \mem_rdata[14]  = _ibus[91];
assign \mem_rdata[13]  = _ibus[90];
assign \mem_rdata[12]  = _ibus[89];
assign \mem_rdata[11]  = _ibus[88];
assign \mem_rdata[10]  = _ibus[87];
assign \mem_rdata[9]  = _ibus[86];
assign \mem_rdata[8]  = _ibus[85];
assign \mem_rdata[7]  = _ibus[84];
assign \mem_rdata[6]  = _ibus[83];
assign \mem_rdata[5]  = _ibus[82];
assign \mem_rdata[4]  = _ibus[81];
assign \mem_rdata[3]  = _ibus[80];
assign \mem_rdata[2]  = _ibus[79];
assign \mem_rdata[1]  = _ibus[78];
assign \mem_rdata[0]  = _ibus[77];
assign pcpi_wr = _ibus[76];
assign \pcpi_rd[31]  = _ibus[75];
assign \pcpi_rd[30]  = _ibus[74];
assign \pcpi_rd[29]  = _ibus[73];
assign \pcpi_rd[28]  = _ibus[72];
assign \pcpi_rd[27]  = _ibus[71];
assign \pcpi_rd[26]  = _ibus[70];
assign \pcpi_rd[25]  = _ibus[69];
assign \pcpi_rd[24]  = _ibus[68];
assign \pcpi_rd[23]  = _ibus[67];
assign \pcpi_rd[22]  = _ibus[66];
assign \pcpi_rd[21]  = _ibus[65];
assign \pcpi_rd[20]  = _ibus[64];
assign \pcpi_rd[19]  = _ibus[63];
assign \pcpi_rd[18]  = _ibus[62];
assign \pcpi_rd[17]  = _ibus[61];
assign \pcpi_rd[16]  = _ibus[60];
assign \pcpi_rd[15]  = _ibus[59];
assign \pcpi_rd[14]  = _ibus[58];
assign \pcpi_rd[13]  = _ibus[57];
assign \pcpi_rd[12]  = _ibus[56];
assign \pcpi_rd[11]  = _ibus[55];
assign \pcpi_rd[10]  = _ibus[54];
assign \pcpi_rd[9]  = _ibus[53];
assign \pcpi_rd[8]  = _ibus[52];
assign \pcpi_rd[7]  = _ibus[51];
assign \pcpi_rd[6]  = _ibus[50];
assign \pcpi_rd[5]  = _ibus[49];
assign \pcpi_rd[4]  = _ibus[48];
assign \pcpi_rd[3]  = _ibus[47];
assign \pcpi_rd[2]  = _ibus[46];
assign \pcpi_rd[1]  = _ibus[45];
assign \pcpi_rd[0]  = _ibus[44];
assign pcpi_wait = _ibus[43];
assign pcpi_ready = _ibus[42];
assign \irq[31]  = _ibus[41];
assign \irq[30]  = _ibus[40];
assign \irq[29]  = _ibus[39];
assign \irq[28]  = _ibus[38];
assign \irq[27]  = _ibus[37];
assign \irq[26]  = _ibus[36];
assign \irq[25]  = _ibus[35];
assign \irq[24]  = _ibus[34];
assign \irq[23]  = _ibus[33];
assign \irq[22]  = _ibus[32];
assign \irq[21]  = _ibus[31];
assign \irq[20]  = _ibus[30];
assign \irq[19]  = _ibus[29];
assign \irq[18]  = _ibus[28];
assign \irq[17]  = _ibus[27];
assign \irq[16]  = _ibus[26];
assign \irq[15]  = _ibus[25];
assign \irq[14]  = _ibus[24];
assign \irq[13]  = _ibus[23];
assign \irq[12]  = _ibus[22];
assign \irq[11]  = _ibus[21];
assign \irq[10]  = _ibus[20];
assign \irq[9]  = _ibus[19];
assign \irq[8]  = _ibus[18];
assign \irq[7]  = _ibus[17];
assign \irq[6]  = _ibus[16];
assign \irq[5]  = _ibus[15];
assign \irq[4]  = _ibus[14];
assign \irq[3]  = _ibus[13];
assign \irq[2]  = _ibus[12];
assign \irq[1]  = _ibus[11];
assign \irq[0]  = _ibus[10];
assign scan_en_w = _ibus[9];
assign edt_update = _ibus[8];
...
`ifdef VCD
    $sformat(_vcd_dump_file_name, "patterns/picorv32_compression_stuck_serial.v.dump");
...
`ifdef UTVCD
    $sformat(_utvcd_dump_file_name, "patterns/picorv32_compression_stuck_serial.v.dump");
    if(_change_out_path) begin 
...
`ifdef debussy
    $sformat(_fsdb_dump_file_name, "patterns/picorv32_compression_stuck_serial.v.fsdb");
    if(_change_out_path) begin 
...
`ifdef QWAVE
    $sformat(_qwave_dump_file_name, "patterns/picorv32_compression_stuck_serial.v.qwave.db");
    if(_change_out_path) begin 
...
initial begin 
   if(_change_path) begin 
     $sformat(_new_filename,"%0s/patterns/picorv32_compression_stuck_serial.v.po.name",_new_path); 
     $display("Loading %0s\n", _new_filename ); 
     $readmemh(_new_filename,_nam_obus,308,0); 
   end 
   else begin
     $display("Loading patterns/picorv32_compression_stuck_serial.v.po.name");
     $readmemh("patterns/picorv32_compression_stuck_serial.v.po.name",_nam_obus,308,0);
   end 
end 
      ...
      if ((_msk_obus[_bit_count] === 1'b1) &&
        ...
        if (_write_DIAG_file == 1) begin
          if (_DIAG_file_header == 0) begin
            if ((_start_pat > -1) && (_end_pat > -1)) begin
              $sformat(_tmp_filename, "patterns/picorv32_compression_stuck_serial.v_%0d_%0d.fail",
                       _start_pat, _end_pat);
            end
            else if (_start_pat > -1) begin
              $sformat(_tmp_filename, "patterns/picorv32_compression_stuck_serial.v_%0d.fail",
                       _start_pat);
            end
            else if (_end_pat > -1) begin
              $sformat(_tmp_filename, "patterns/picorv32_compression_stuck_serial.v__%0d.fail",
                       _end_pat);
            end
            else begin
              $sformat(_tmp_filename, "patterns/picorv32_compression_stuck_serial.v.fail");
            end
            if(_change_out_path) begin 
            ...
            if(_change_out_path) begin 
              $fwrite(_diag_file, "// This File is simulation generated (%0s/patterns/picorv32_compression_stuck_serial.v)\n", _new_out_path);
            end
            else begin
              $fwrite(_diag_file, "// This File is simulation generated (patterns/picorv32_compression_stuck_serial.v)\n");
            end
        ...
        if (_write_MASK_file == 1) begin
          if (_MASK_file_header == 0) begin
            if ((_start_pat > -1) && (_end_pat > -1)) begin
              $sformat(_tmp_filename, "patterns/picorv32_compression_stuck_serial.v_%0d_%0d.mask",
                       _start_pat, _end_pat);
            end
            else if (_start_pat > -1) begin
              $sformat(_tmp_filename, "patterns/picorv32_compression_stuck_serial.v_%0d.mask",
                       _start_pat);
            end
            else if (_end_pat > -1) begin
              $sformat(_tmp_filename, "patterns/picorv32_compression_stuck_serial.v__%0d.mask",
                       _end_pat);
            end
            else begin
              $sformat(_tmp_filename, "patterns/picorv32_compression_stuck_serial.v.mask");
            end
            if(_change_out_path) begin 
              $sformat(_tmp_filename, "%0s/%0s", _new_out_path, _tmp_filename);
            end
...
//  $display("Reading checkpoint patterns/picorv32_compression_stuck_serial.v.dat");
//  $restart("patterns/picorv32_compression_stuck_serial.v.dat");
end
...
if ($value$plusargs("CONFIG=%0s", _cfg_file_name)) begin
  ...
  _cfg_file_name = "patterns/picorv32_compression_stuck_serial.v.cfg";
end
...
if(_change_path) begin 
  $sformat(_new_filename,"%0s/patterns/picorv32_compression_stuck_serial.v.cfg",_new_path); 
  _config_file = $fopen(_new_filename, "r");
end
else begin
  _config_file = $fopen("patterns/picorv32_compression_stuck_serial.v.cfg", "r");
end
               ...
               1'b1: begin // timeplate 1 - gen_tp1
                  ...
                  if ((_miscompare_limit)&&(_compare_fail>=_miscompare_limit)) begin
                    ...
                    if (_DIAG_file_header == 1) begin
                       ...
                       $fwrite(_diag_file, "total_cycles 4495\n");
...
//  $display("Writing checkpoint patterns/picorv32_compression_stuck_serial.v.dat");
//  $save("patterns/picorv32_compression_stuck_serial.v.dat");

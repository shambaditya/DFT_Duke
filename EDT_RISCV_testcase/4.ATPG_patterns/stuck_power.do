...
## for power
set_core_instance_parameters -instance picorv32_rtl1_tessent_edt_c1_inst -parameter {edt_low_power_shift_en on}
...
set_power_control shift on -switching_threshold_percentage 20 -rejection_threshold_percentage 25
set_power_control capture on -switching_threshold_percentage 25 -rejection_threshold_percentage 30
report_power_control
...
write_patterns patterns/picorv32_power_stuck_parallel.v -verilog -parallel -replace -parameter_list {SIM_KEEP_PATH 1}
set_pattern_filtering -sample_per_type 2
write_patterns patterns/picorv32_power_stuck_serial.v -verilog -serial -replace -parameter_list {SIM_KEEP_PATH 1}

...
write_patterns patterns/picorv32_stuck_parallel.v -verilog -parallel -replace -parameter_list {SIM_KEEP_PATH 1}
set_pattern_filtering -sample_per_type 2
write_patterns patterns/picorv32_stuck_serial.v -verilog -serial -replace -parameter_list {SIM_KEEP_PATH 1}

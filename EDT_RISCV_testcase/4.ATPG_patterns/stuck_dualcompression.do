...
## for new high compression configuration
set_core_instance_parameters -instance picorv32_rtl1_tessent_edt_c1_inst -parameter {edt_configuration high_compression}
...
write_patterns patterns/picorv32_compression_stuck_parallel.v -verilog -parallel -replace -parameter_list {SIM_KEEP_PATH 1}
set_pattern_filtering -sample_per_type 2
write_patterns patterns/picorv32_compression_stuck_serial.v -verilog -serial -replace -parameter_list {SIM_KEEP_PATH 1}

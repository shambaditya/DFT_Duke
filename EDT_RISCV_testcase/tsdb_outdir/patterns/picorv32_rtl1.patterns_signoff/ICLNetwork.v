...
// Filename       : ../tsdb_outdir/patterns/picorv32_rtl1.patterns_signoff/ICLNetwork.v
// Idstamp        : 2024.4:ec94:9fce:0:0000
// Date           : Thu Nov 20 12:09:58 2025
//
...
picorv32 DUT_inst (.scan_en_w(scan_en_w));
      ...
      case (_pat_type)
         ...
         3'b011:  begin // status message vector
            ...
            case (_message_index)
               ...
               20: begin
                  $display($realtime, "ns: Pattern_set picorv32");
               end
               default: begin
